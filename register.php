    ...
    <div class="container">
        <div style="min-height: 100vh;" class="d-flex align-items-center justify-content-center">
            <div style="width: 100%; max-width : 500px;" class="bg-white rounded shadow-sm p-4">
                <h4 class="mb-4">Sign up for new account</h4>
                <form action="add-user.php" class="row g-3" method="post">

                    <div class="col-12">
                        <label class="form-label" for="name">Name</label>
                        <input placeholder="Enter your name" type="text" class="form-control" name="name" id="name">
                    </div>
                    ...
                    <div class="col-12">
                        <a class="text-decoration-none" href="/login.php">Already have an account? Sign In</a>
                    </div>
